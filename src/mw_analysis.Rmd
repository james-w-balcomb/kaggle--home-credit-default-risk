...
# reformat to numerics and factors:
...
#update other DAYS_ features:
train.X.filt[train.X.filt$DAYS_EMPLOYED < 0, c("DAYS_EMPLOYED")] <- 0
train.X.filt[train.X.filt$DAYS_REGISTRATION < 0, c("DAYS_REGISTRATION")] <- 0
train.X.filt[train.X.filt$DAYS_LAST_PHONE_CHANGE < 0, c("DAYS_LAST_PHONE_CHANGE")] <- 0
