...
write.csv(sum_bureau.csv, "../data/sum_bureau.csv")
write.csv(sum_cc_balance.csv, "../data/sum_cc_balance.csv")
write.csv(sum_payments.csv, "../data/sum_payments.csv")
write.csv(sum_pc_balance.csv, "../data/sum_pc_balance.csv")
write.csv(sum_prev.csv, "../data/sum_prev.csv")
